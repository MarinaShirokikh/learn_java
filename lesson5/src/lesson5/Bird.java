...
public class Bird extends Animal {
    public static int maxRunDistance = 5;
    public static boolean swimSkill;
    public static double maxHeightJump = 0.2; // возможно достаточно float
    ...
    public void run(int distance){
        ...
        }else System.out.println(this.name + " can't run a distance " + distance + ". Max distance for bird: " + maxRunDistance);
    }
