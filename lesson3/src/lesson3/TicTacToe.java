...
public class TicTacToe {
    ...
    private static void initField() {
        fieldSizeY = FIELD_SIZE_Y;
        fieldSizeX = FIELD_SIZE_X;
    ...
    private static boolean checkWin(char c) {
        ...
        for (int i = 0; i < fieldSizeY; i++) {
            if (field[i][i] == c) {
                d1++; //диагональ слева направо
            }
            if (field[i][fieldSizeY - 1 - i] == c) {
                d2++; //диагональ справа налево
            }
            stroka = 0;
            stolbec = 0;
            ...
            if (stroka == WIN_COUNT || stolbec == WIN_COUNT) return true;
        }
        return d1 == WIN_COUNT || d2 == WIN_COUNT;
    }
